...
def find_best_move(board, all_legal_moves, obj_set, player_turn, set_pieces, player1_set, player2_set, player3_set,
                   player4_set, player5_set, player6_set,algorithm):
    ...
    try:
        ...
        if player_turn == 1:
            ...
            if algorithm == greedy:
                best_move = algorithm(board, all_legal_moves, obj_set, player_turn)
            elif algorithm == minimax:
                score, best_move = algorithm(board, depth, player_turn, player_turn, player1_set, player2_set,
                                             player3_set, player4_set, player5_set, player6_set)
            elif algorithm == cnn:
                best_move=algorithm(board)
            else:
                score,best_move=algorithm(board, depth, player_turn, player_turn, player1_set, player2_set,
